...
export interface HeroSliceDefaultPrimary {
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.secon
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
 ...
 */
export interface SkyDivwSliceDefaultPrimary {
  /**
   * Sentence field in *SkyDive → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: sky_divw.default.primary.sentence
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
   ...
   * - **API ID Path**: sky_divw.default.primary.flavor
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SkyDivwSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<SkyDivwSliceDefaultPrimary>,
  never
>;
 ...
 */
type SkyDivwSliceVariation = SkyDivwSliceDefault;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SkyDivwSlice = prismic.SharedSlice<
  "sky_divw",
  SkyDivwSliceVariation
>;
